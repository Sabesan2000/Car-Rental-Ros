...
if ($deposit >= 225){
  $reg = "INSERT INTO booking(customer_id, bookingStart, bookingEnd, bookingLocation, bookingDelivery, vehicleMake, vehicleModel) VALUES ('$customerID','$startDate', '$endDate', 'Downtown', '$deliveryOption', 'Lexus', 'LC500')";
...
//If the deposit is less the 50% of the rental price, then print out a message to do so
  ...
  $message = "Minimum Deposit must be above $225.";
  echo "<script type='text/javascript'>alert('$message'); window.location.href = 'inventory.php'</script>";
  echo '</html>';
}
?>
