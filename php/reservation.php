          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-content">
                <p>
                  <?php
                $queryReservation = "SELECT DISTINCT vehicleMake, vehicleModel, bookingStart, bookingEnd FROM customers FULL JOIN booking ON '$customerID' = customer_id;";
                $reservationResult = mysqli_query($connection, $queryReservation);
                echo "<table border='1'><tr><th>Vehicle Make</th><th>Vehicle Model</th><th>Start Date</th><th>End Date</th></tr>";


                while($reservationRow = mysqli_fetch_assoc($reservationResult)){
                  echo "<tr>";
                  echo "<td>" . $reservationRow['vehicleMake'] . "</td>";
                  echo "<td>" . $reservationRow['vehicleModel'] . "</td>";
                  echo "<td>" . $reservationRow['bookingStart'] . "</td>";
                  echo "<td>" . $reservationRow['bookingEnd'] . "</td>";
                  echo "</tr>";
                }
                echo "</table>";
